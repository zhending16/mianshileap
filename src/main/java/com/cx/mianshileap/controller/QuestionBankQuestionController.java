...
import com.cx.mianshileap.model.dto.questionBankQuestion.*;
import com.cx.mianshileap.model.entity.QuestionBankQuestion;
import com.cx.mianshileap.model.entity.User;
import com.cx.mianshileap.model.vo.QuestionBankQuestionVO;
import com.cx.mianshileap.service.QuestionBankQuestionService;
...
public class QuestionBankQuestionController {
    ...
    public BaseResponse<Long> addQuestionBankQuestion(@RequestBody com.cx.mianshileap.model.dto.questionBankQuestion.QuestionBankQuestionAddRequest questionBankQuestionAddRequest, HttpServletRequest request) {
    ...
    @PostMapping("/update")
    @SaCheckRole(UserConstant.ADMIN_ROLE)
    public BaseResponse<Boolean> updateQuestionBankQuestion(@RequestBody com.cx.mianshileap.model.dto.questionBankQuestion.QuestionBankQuestionUpdateRequest questionBankQuestionUpdateRequest) {
    ...
    @SaCheckRole(UserConstant.ADMIN_ROLE)
    public BaseResponse<Page<QuestionBankQuestion>> listQuestionBankQuestionByPage(@RequestBody com.cx.mianshileap.model.dto.questionBankQuestion.QuestionBankQuestionQueryRequest questionBankQuestionQueryRequest) {
    ...
    public BaseResponse<Page<QuestionBankQuestionVO>> listQuestionBankQuestionVOByPage(@RequestBody com.cx.mianshileap.model.dto.questionBankQuestion.QuestionBankQuestionQueryRequest questionBankQuestionQueryRequest,
    ...
    public BaseResponse<Page<QuestionBankQuestionVO>> listMyQuestionBankQuestionVOByPage(@RequestBody com.cx.mianshileap.model.dto.questionBankQuestion.QuestionBankQuestionQueryRequest questionBankQuestionQueryRequest,
                                                                                         HttpServletRequest request) {
    ...
    public BaseResponse<Boolean> removeQuestionBankQuestion(
            @RequestBody com.cx.mianshileap.model.dto.questionBankQuestion.QuestionBankQuestionRemoveRequest questionBankQuestionRemoveRequest
    ) {
        // 参数校验
    ...
    public BaseResponse<Boolean> batchAddQuestionsToBank(
            @RequestBody com.cx.mianshileap.model.dto.questionBankQuestion.QuestionBankQuestionBatchAddRequest questionBankQuestionBatchAddRequest,
            HttpServletRequest request
    ) {
    ...
    public BaseResponse<Boolean> batchRemoveQuestionsFromBank(
            @RequestBody com.cx.mianshileap.model.dto.questionBankQuestion.QuestionBankQuestionBatchRemoveRequest questionBankQuestionBatchRemoveRequest,
            HttpServletRequest request
    ) {
